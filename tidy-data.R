...
#use the correct bind join function to add a salary column to the top_names
Salaries %>% as_tibble() #Inspect salaries data frame
...
AwardsPlayers %>% as_tibble() #Inspect awards data frame
...
### (https://rafalab.github.io/dsbook/web-scraping.html) IMPORTANT!!!!!
...
#Use the html_nodes() function and the table node type to extract the first table. Store it in an object nodes
...
###
#Brexit data. One table contains the results of all polls regarding the referendum over 2016
library(rvest)
library(tidyverse)
url <- "https://en.wikipedia.org/w/index.php?title=Opinion_polling_for_the_United_Kingdom_European_Union_membership_referendum&oldid=896735054"
b <- read_html(url)

tab <- html_nodes(b, "table")
